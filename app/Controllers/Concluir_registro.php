	...
	public function index()
	{
		if($this->session->get('logged'))
		{
			...
			$data['form_field']		=		[
												...
												['texto', 'Estaremos revisando tus documentos y si hubiera alguna observación o bien, esté aprobado tu registro te llegará un correo en un plazo máximo de 5 días hábiles.<br><br>¡Muchas gracias!<br>Cualquier duda estamos a tus órdenes en el teléfono<br>(472) 103 9900 EXT 158 y 160'],
