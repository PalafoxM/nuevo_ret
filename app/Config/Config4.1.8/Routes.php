...
$routes->get('formato-unico-guias', 'Redireccion::documento/15');
$routes->get('directorio-guias', 'Redireccion::documento/16');
$routes->get('consulta-ciudadana', 'Redireccion::enlace/5');
