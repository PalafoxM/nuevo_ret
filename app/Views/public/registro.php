<main class="signup-shell">
  <section class="signup-hero">
    <div class="signup-copy">
      ...
      <p class="signup-lead">Eliminamos el pre-registro por correo para que el alta sea más directa, clara y cómoda. Captura tu email, confirmalo y continuamos al formulario principal.</p>
      ...
      <div class="signup-highlights">
        <article class="signup-highlight-card">
          ...
          <div>
            ...
            <p>Entras al registro sin esperar ligas de validación.</p>
          </div>
        </article>
        <article class="signup-highlight-card">
          <span class="signup-highlight-icon"><i class="bi bi-shield-check"></i></span>
          <div>
            <h2>Flujo más simple</h2>
            <p>Menos pasos y menos puntos de falla para completar el trámite.</p>
          </div>
        </article>
        <article class="signup-highlight-card">
          ...
          <div>
            ...
            <p>Ten a la mano RFC, datos del establecimiento y documentos básicos.</p>
          </div>
        </article>
      </div>
    </div>
    ...
    <div class="signup-panel">
      <div class="signup-card">
        ...
        <h2 class="ret-titulo signup-card-title"> Inscríbete al RET</h2>
        ...
        <form id="signin_form" class="signup-form" action="<?=BASE_URL?>pre-registro" method="post" novalidate>
          ...
          <div class="signup-inline-note">
            ...
            Continuarás directamente al formulario de registro.
          </div>
        ...
        <a class="signup-secondary-link" href="<?=BASE_URL?>ingresar">¿Ya eres usuario? Inicia sesión</a>
      </div>
    </div>
  </section>
</main>
