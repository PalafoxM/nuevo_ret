<main class="home-shell">
  <section class="home-hero container_ret">
    <div class="home-hero-copy">
      ...
      <div class="home-pill-row">
        <span class="home-pill"><i class="bi bi-stars"></i> Trámite digital</span>
        <span class="home-pill"><i class="bi bi-patch-check"></i> Beneficios visibles</span>
        <span class="home-pill"><i class="bi bi-building"></i> Prestadores de servicios turísticos</span>
      </div>

      <div class="home-cta-row">
        <a href="<?=BASE_URL?>registro" class="home-primary-cta">
          <small>Comenzar ahora</small>
          <strong><i class="bi bi-person-plus"></i> Inscríbete al RET</strong>
        </a>
      ...
      <div class="home-stats-grid">
        ...
        <article class="home-stat-card">
          <strong>02</strong>
          <span>Accede rápido al registro nuevo o retoma un trámite en curso.</span>
        </article>
        <article class="home-stat-card">
          <strong>03</strong>
    ...
    <div class="home-hero-visual">
      <div class="home-visual-frame home-visual-main">
        <div class="home-visual-overlay">
          ...
          <p>Capacitación, difusión, consulta ciudadana y una plataforma más simple para crecer con orden.</p>
        </div>
      </div>
  ...
  <section class="home-section container_ret">
    <div class="home-section-header">
      <div>
        <span class="home-section-kicker">Ruta rápida</span>
        <h2 class="ret-titulo">Todo lo esencial, a un clic.</h2>
      </div>
      <p>Reordenamos los accesos más consultados para que la portada sirva como punto de entrada real al sistema y no solo como un listado de enlaces.</p>
    </div>
    ...
    <div class="container_ret">
      <div class="home-dual-panel">
        <div class="home-panel home-panel-primary">
          ...
          <h2>¿Qué ganas al estar dentro del RET?</h2>
          <ul class="home-benefit-list">
            <li>Participación en programas de capacitación y certificación.</li>
            <li>Mayor facilidad para trámites complementarios como el RNT.</li>
            <li>Difusión en plataformas digitales y herramientas de consulta.</li>
            <li>Visibilidad institucional para el prestador de servicios turísticos.</li>
          </ul>
        </div>
        ...
        <div class="home-panel home-panel-secondary">
          ...
          <div class="home-action-stack">
            <a href="<?=BASE_URL?>registro" class="home-action-card">
              ...
              <span>Abre tu expediente y comienza el trámite desde cero.</span>
            </a>
            ...
            <a href="<?=BASE_URL?>consulta-ciudadana" class="home-action-card">
              ...
              <span>Explora la información pública de los registros visibles.</span>
            </a>
          </div>
        </div>
      </div>
  ...
  <section class="home-section container_ret">
    <div class="home-section-header">
      <div>
        <span class="home-section-kicker">Enlaces de interés</span>
        <h2 class="ret-titulo">Herramientas y portales aliados</h2>
      </div>
      <p>Una selección más limpia de accesos externos para consulta, difusión y apoyo al sector turístico.</p>
    </div>
    ...
    <div class="home-links-grid">
      ...
      <a href="<?=BASE_URL?>oteg" target="_blank" class="home-link-card home-link-3">
        <span>Observatorio Turístico</span>
      </a>
